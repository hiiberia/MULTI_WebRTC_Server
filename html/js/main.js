...
function getCurrentUserId() {
	//console.log('getCurrentUserId(): location: ' + JSON.stringify(location)); // Debug
	var parameters = parseRequestParemeters(location.search);
	console.log('getCurrentUserId(): ' + parameters.userid); // Debug
...
function getCurrentUserName() {
	//console.log('getCurrentUserName(): location: ' + JSON.stringify(location)); // Debug
	var parameters = parseRequestParemeters(location.search);
	console.log('getCurrentUserName(): ' + parameters.name); // Debug
